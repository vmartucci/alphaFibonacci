...
<html lang="it">
    ...
    <body>
        ...
        <!-- DEL <div id="header-placeholder"></div> -->
        <!-- ADD ===== HEADER (incluso server-side) ===== -->
        ...
        <div class="rettangolo-sezione">
            ...
            <div class="blocco">
                <div class="contenuto-immagine img-left">
                    <img src="src/resources/img/img1.png" alt="Successione di Fibonacci">  <!-- sostituire con img -->
                </div>
        ...
        <div class="rettangolo-sezione">
            ...
            <!-- per mantenere l'effetto a scacchiera rispetto ai blocchi sopra, qui ricomincio con testo a sinistra -->
            <div class="blocco">
                <div class="contenuto-testo txt-left">
                    <h3>Approfondimenti matematici</h3>
                    <p>
                        La successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
                        combinatorie e geometriche interessanti.La successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
                        combinatorie e geometriche interessanti.La successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
                        combinatorie e geometriche interessanti.La successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
            ...
            <div class="blocco">
                ...
                <div class="contenuto-testo txt-right">
                    <h3>Applicazioni</h3>
                    <p>
                        LaLa successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
                        combinatorie e geometriche interessanti.La successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
                        combinatorie e geometriche interessanti.La successione di Fibonacci è collegata al rapporto aureo e a molte proprietà
                        combinatorie e geometriche interessanti. successione appare in natura, in algoritmi e in applicazioni grafiche: è uno strumento molto versatile.
                    </p>
                </div>
            </div>
        ...
        <!-- DEL <div id="footer-placeholder"></div> -->
        <!-- DEL <script src="src/js/include.js"></script> -->
